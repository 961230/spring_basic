...
import static org.junit.jupiter.api.Assertions.assertThrows;class ApplicationContextSameBeanFindTest {
    ...
    void findAllBeanByType() {
        ...
        for (Map.Entry<String, MemberRepository> stringMemberRepositoryEntry : beansOfType.entrySet()) {
            System.out.println("<Key : Value> = " + "<" + stringMemberRepositoryEntry + ">");
        }
